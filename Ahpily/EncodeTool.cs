   ...
   public static class EncodeTool
    {
        ...
        public  static byte[] EncodeMsg(SocketMsg msg)
        {
            ...
            //如果不等于null,才需要把object 转换为字节数据 存起来
            if(msg.Value!=null)
            {
        ...
        /// 反序列化对象
        /// </summary>
        public static DecodeObjDelegate decodeObjDelegate;
